...
no_images = 13
infrared_out_size = 100
color_out_size = 250

if __name__ == "__main__":
    for sbj in range(no_images):
        root = os.path.join('data', 'Raw_Val', 'sbj-'+str(sbj))
        root_out = os.path.join('data', 'validation', 'sbj-'+str(sbj))
